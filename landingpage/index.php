        ...
        <div class="card">
            <div class="side front">
                ...
                <div class="info">
                    ...
                    <p>A high-performance zero-turn with unsurpassed strength, speed &amp; reliability with a warranty
                        to match.</p>
                </div>
            </div>
            <div class="side back">
                <div class="info">
                    ...
                    <ul>
                        ...
                        <li>The 37hp Vanguard BigBlock EFI makes short work out of big jobs enabling speeds up to 16mph
                        </li>
        ...
        <div class="card">
            <div class="side front">
                ...
                <div class="info">
                    ...
                    <p>If you need a tough, commercial grade engine that makes you more productive, look to Vanguard.
                    </p>
                </div>
            </div>
            <div class="side back">
                <div class="info">
                    ...
                    <ul>
                        <li>V-Twin OHV Technology provides superior balance, low vibration, lower emissions, better fuel
                            economy and higher HP/Weight</li>
                        <li>Advanced Debris Management keeps engine clean and cool for enhanced durability and
                            performance</li>
                    </ul>
                    <div class="btn">
                        <h4>Learn More</h4>
